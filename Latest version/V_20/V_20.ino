...
Features:
- Selectable modes at boot, audio vario with integrated speaker or bluetooth 
paired to smartphone and paragliding apps (I used xctrack)
- Powered by 2S lipo battery (7.4 to 8.4 Volts), you can use most of the arduino boards
- Using LK8EX1 BT protocol, battery voltage is readable from from the app
- TODO: Audible warning when battery low voltage occurs, to preserve battery
- TODO: Variable speaker volume

Release notes:
Version 20, introducing the low voltage battery alarm.
